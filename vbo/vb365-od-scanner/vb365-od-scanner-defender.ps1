...
if ($daysback -gt "0") 
    {
    $restorePoint = Get-VBORestorePoint | Where-Object -Property isOneDrive | Where-Object {$_.BackupTime -ge $filterDate.Date} | Sort-Object -Property BackupTime -Descending | Select-Object -First 1
