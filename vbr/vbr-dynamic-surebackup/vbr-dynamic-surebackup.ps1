...
.NOTES  
    ...
    Author     : Stephan "Steve" Herzig and many others (See Readme on GitHub)
...
$VbsStartOptions = New-VBRSureBackupStartupOptions -AllocatedMemory 100 -EnableVMHeartbeatCheck:$true -EnableVMPingCheck:$false -MaximumBootTime 600 -ApplicationInitializationTimeout 120 -DisableWindowsFirewall:$true
